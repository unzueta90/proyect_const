                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <p>Dado el carácter dinámico que presentan los volúmenes de tránsito (TRÁNSITO PROMEDIO
                                    DIARIO ANUAL),
                                    es necesario conocer las variaciones periódicas que tiene el mismo dentro de las horas
                                    de máxima demanda, en las horas del día, en los días de la semana y en los meses del
                                    año. Así mismo, se debe considerar las variaciones de los volúmenes de tránsito en
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <p>Es la desintegración total de la superficie de rodadura que puede extenderse a otras
                                    capas del pavimento, formando una cavidad de bordes y profundidades irregulares. Tambien
                                    se considera en el afloramiento de un material bituminoso de la mezcla asfáltica a la
                                    superficie del pavimento, formando una película contínua de ligante, creando una
                                    superficie brillante, reflectante, resbaladiza y pegajosa durante el tiempo cálido.</p>
                                <a href="#featured-services" class="btn-get-started scrollto">Registrarse</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <p>La capacidad se define como el máximo número de vehículos que pueden circular por una vía
                                    en un periodo determinado bajo las condiciones prevalecientes de la infraestructura
                                    vial, del tránsito y de los dispositivos de control. Refleja la habilidad de la vía para
                                    acomodar una corriente de movimiento de vehículos.</p>
                                <a href="#featured-services" class="btn-get-started scrollto">Registrarse</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <p>En medida que cualquier ciudad crece las necesidades de sus habitantes se incrementan
                                    notoriamente generando una “dinámica de ciudad” que genera movimiento económico,
                                    poblacional y por ende vehicular (mientras una ciudad crece el tráfico vehicular se
                                    incrementa) por lo que el trasladarse de un punto de la ciudad a otro se vuelve
                                    indispensable.</p>
                                <a href="#featured-services" class="btn-get-started scrollto">Registrarse</a>
                            </div>
                        </div>
        ...
        <section id="Vias">
            <div class="container">
                ...
                <header class="section-header">
                    <h3>Tipos de Vias</h3>
                    <p> Las vías terrestres son obras de infraestructuras , que se diseñaron para mejorar el transporte y
                        disminuir el tiempo que se tarda en movilizarse de un punto a otro, entre las vías terrestres están:
                        carreteras, autopistas, caminos.</p>
                </header>
                ...
                <div class="row about-cols">
                    ...
                    <div class="col-md-4 wow fadeInUp">
                        <div class="about-col">
                            ...
                            <p>
                                La carretera o ruta es un camino público pavimentado que está dispuesto para el tránsito de
                                vehículos. Por lo general se trata de vías anchas que permiten fluidez en la circulación.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="about-col">
                            ...
                            <p>
                                es un vía especialmente reservada para automóviles, con un único carril hacia el mismo
                                sentido y con limitación de acceso desde las propiedades colindantes. No tendrán acceso
                                otros vehículos distintos de los automóviles. </p>
                        </div>
                    </div>
        ...
        <section id="Vehiculos">
            <div class="container">
                ...
                <header class="section-header">
                    ...
                    <p>Los diferentes volúmenes de tráfico que se obtienen de las estaciones programadas durante el año y
                        que clasifican los contadores de tráfico por automotores en ambos Sentidos de circulación.</p>
                </header>
