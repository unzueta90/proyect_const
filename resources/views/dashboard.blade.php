            ...
            <div class="row about-cols">
                ...
                <div class="col-md-4 wow fadeInUp">
                    <div class="about-col">
                        ...
                        <p>
                            ...
                            vehículos. Por lo general se trata de vías anchas que permiten fluidez en la circulación. </p>
                    </div>
                </div>
                ...
                <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="about-col">
                        ...
                        <p>
                            es un vía especialmente reservada para automóviles, con un único carril hacia el mismo sentido y
                            con limitación de acceso desde las propiedades colindantes. No tendrán acceso otros vehículos
                            distintos de los automóviles. </p>
                    </div>
                </div>
    ...
    <section id="Vehiculos">
        <div class="container">
            ...
            <header class="section-header">
                ...
                <p>Los diferentes volúmenes de tráfico que se obtienen de las estaciones programadas durante el año y que
                    clasifican los contadores de tráfico por automotores en ambos Sentidos de circulación.</p>
            </header>
